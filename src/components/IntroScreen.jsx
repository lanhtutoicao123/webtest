...
const Hero = () => {
    return(
        ...
        <div className="titleContainer">
          ...
          <h1 className="tracking-in-expand-fwd">PHẠM THỊ BÍCH PHƯỢNG </h1>
          <h3 className="subTitle"> TRANG WEB NÀY DÀNH RIÊNG CHO EM </h3>
          ...
          <div class="wrap">
            <Link to="/music">
                <button class="button">Bấm vào đây để nghe nè</button>
            </Link>         
          </div>
        </div>
        <ReactPlayer 
